var erros = 0;
var listaCartas = ["nezuko linda", "Tanjiro", "inosuke","zenitsu", "tomioka", "rengoku", 
"shinobu2", "kanao", "yorichi","sabito"]
...
if (this.src.includes("icon")){
    if (!carta1selecionada) {
        ...
        carta1selecionada.src = tabuleiro [l][c] + ".jpg";
        ...
        carta2selecionada.src = tabuleiro [l][c] + ".jpg";
...
function atualizar() {
    ...
    if (carta1selecionada.src != carta2selecionada.src) {
        carta1selecionada.src = "icon.jpg";
        carta2selecionada.src = "icon.jpg";
        erros += 1;
